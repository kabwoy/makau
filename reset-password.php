...
<nav class="navbar navbar-light bg-light">
    ...
    <img src="images/mtti.jpg" width="50" height="50" class="d-inline-block align-top" alt="">
    MASAI TECHNICAL TRAINING INSTITUTE
  </a>

  <form class="form-inline my-2 my-lg-0">
      <img src="images/mtti.jpg" style="width:50px; height: 50px; margin-right:10px" alt="#">
